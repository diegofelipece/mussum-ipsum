...
var mIpsum = function mIpsum() {
  var pNum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var quotes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : mussumQuotes;
  var mainQuote = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : mussumMainQuote;
  var maxOfp = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 9999;
  ...
  /*  create
  ----------------- > */
  var createParagraphs = function createParagraphs(pNum, quotes) {
